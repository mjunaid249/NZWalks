    ...
    public partial class SeedingDataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3f165535-13cb-4fcd-9fbd-367abb707be7"), "Medium" },
                    { new Guid("478eb301-17a3-4548-8aa7-7304400a51ff"), "Hard" },
                    { new Guid("f848c0b3-8f15-4690-9e69-ca1e58b61b4a"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("3f165535-13cb-4fcd-9fbd-367abb707be7"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("478eb301-17a3-4548-8aa7-7304400a51ff"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f848c0b3-8f15-4690-9e69-ca1e58b61b4a"));
